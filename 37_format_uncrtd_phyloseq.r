#' ---
#' title: "Inclusion of sample data into **uncorrected** `phyloseq` object (**Only done to allow plotting with existent code subsequently**)."
...
#' and can be rendered at any stage using `rmarkdown::render ("./37_format_uncrtd_phyloseq.r")`.
...
#' eukaryotic data available.
#'
#' ### Import  Locations
#'
#' Reading uncorrected data.
path_phsq_18S_in <- "./Zenodo/R_Objects/560_psob_18S_default_filtered.RData" 
...
path_phsq_ob   <- "./Zenodo/R_Objects/37_phsq_ob.Rdata"
                 
#' Work space for future reference. 
path_workspace <- "./Zenodo/R_Objects/37_workspace.Rdata"
...
#' Showing the plots.:
#+ message=FALSE, results='hide', warning=FALSE, fig.width=7, fig.height=7, dpi=200, fig.align='center',  fig.cap="Invertebrate abundances at class level. RAW sequence counts, not CSS'd. (approx. code line 247)"
